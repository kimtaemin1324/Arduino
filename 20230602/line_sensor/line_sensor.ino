...
void setup()
{
  ...
  */
  ...
  void loop1()
  {
    ...
    imu_rotation();
    run_heading_angle();
    target_heading_angle = 125;
    imu_rotation();
    run_heading_angle();
    target_heading_angle = 97;
    imu_rotation();
    run_heading_angle();
    target_heading_angle = 195;
    imu_rotation();
    run_heading_angle();
    target_heading_angle = 355;
    imu_rotation();
    run_heading_angle();
    target_heading_angle = 106;
    imu_rotation();
    run_heading_angle();
    target_heading_angle = 54;
    imu_rotation();
    run_heading_angle();
    target_heading_angle = 333;
    imu_rotation();
    run_heading_angle();
    target_heading_angle = 25;
    imu_rotation();
    run_heading_angle();
    
    target_heading_angle = 69;
    imu_rotation();
    run_heading_angle();*/
  }
